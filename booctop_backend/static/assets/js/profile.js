    ...
    if ($(this).attr('id') == 'follow-pop') {
      if ($(this).hasClass('is-shifted')) {
        ...
        iziToast.show({
          ...
          icon: 'mdi mdi-cart',
          title: '',
          message: 'You have successfuly remove this course from your cart',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
        ...
        iziToast.show({
          ...
          icon: 'mdi mdi-cart',
          title: '',
          message: 'You have successfuly add this course to your cart',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
          backgroundColor: '#7F00FF',
      ...
      if ($(this).hasClass('is-shifted')) {
        ...
        iziToast.show({
          ...
          title: '',
          message: 'You have successfuly remove this course from your Favorite page',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
          backgroundColor: '#7F00FF',
        ...
        iziToast.show({
          ...
          icon: 'mdi mdi-heart',
          title: '',
          message: 'You have successfuly add this course to your Favorite page',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
          backgroundColor: '#7F00FF',
