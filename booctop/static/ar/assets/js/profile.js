    ...
    if ($(this).attr('id') == 'follow-pop') {
      if ($(this).hasClass('is-shifted')) {
        ...
        iziToast.show({
          ...
          icon: 'mdi mdi-cart',
          title: '',
          message: 'قمت بنجاح بحذف هذه الدورة من السلة',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
          backgroundColor: '#2f7bd1',
          progressBarColor: '#2f7bd1',
          position: 'bottomLeft',
        ...
        iziToast.show({
          ...
          icon: 'mdi mdi-cart',
          title: '',
          message: 'قمت بنجاح اضافة هذه الدورة للسلة',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
          backgroundColor: '#2f7bd1',
      ...
      if ($(this).hasClass('is-shifted')) {
        ...
        iziToast.show({
          ...
          title: '',
          message: 'قمت بحذف الدورة بنجاح من مفضلتك',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
          backgroundColor: '#2f7bd1',
        ...
        iziToast.show({
          ...
          icon: 'mdi mdi-heart',
          title: '',
          message: 'قمت بإضافة هذه الدورة بنجاح للمفضلة',
          titleColor: '#fff',
          messageColor: '#fff',
          iconColor: "#fff",
          backgroundColor: '#2f7bd1',
